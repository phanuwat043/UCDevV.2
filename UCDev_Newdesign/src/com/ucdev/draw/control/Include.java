...
public class Include {
    ...
    public Include(DrawUsecase uc_first, DrawUsecase uc_second) {
    ...
    public void paint(JComponent parent, Graphics2D g2d) {
        ...
        BasicStroke bs = new BasicStroke(1.0f, BasicStroke.CAP_BUTT, BasicStroke.JOIN_BEVEL,
                1.0f, dash, 2f);
    ...
    private void drawArrow(Graphics2D g2d) {
        ...
        double angle = Math.atan2(y - endY, x - endX);
